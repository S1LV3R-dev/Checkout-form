    ...
    <div id="card_info_block">
        <form id="card_info">
            ...
            <div id="card">
                ...
                <div id="card_bottom">
                    <div id="card_bottom_left">
                        <div class="card_label">Card holder</div>
                        <span>
                            {{ name.toUpperCase() || 'FULL NAME' }}
                        </span>
                    </div>
                    <div id="card_bottom_right">
                        <div class="card_label">Expires</div>
                        {{ month || 'MM' }}/{{ year || 'YY' }}
                    </div>
                </div>
            </div>
            <div id="card_info_input">
                ...
                <input
                    type="text"
                    class="card-info-input-field"
                    @input="card_num = value + mask.slice(value.length)"
                    v-mask="mask"
                    v-model="value"
                />
            ...
            <div id="price_tag">{{ price }} USD</div>
            <div id="confirm">
